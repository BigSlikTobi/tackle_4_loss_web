class TeamArticle {
  ...
  factory TeamArticle.fromJson(Map<String, dynamic> json) {
    return TeamArticle(
      ...
      summary: json['summary'] ??
          (json['content'] != null
              ? (json['content'] as String).substring(
                  0,
                  (json['content'] as String).length > 100
                      ? 100
                      : (json['content'] as String).length)
              : ''),
      imageUrl: json['imageUrl'] ?? json['image'] ?? json['image_url'] ?? '',
      audioUrl: json['tts_file'],
      publishedAt:
          DateTime.tryParse(json['published_at'] ?? json['created_at'] ?? '') ??
              DateTime.now(),
  ...
  factory TeamArticle.mock() {
    return TeamArticle(
      ...
      summary:
          'Head coach discusses the defensive adjustments made during practice this week.',
      imageUrl:
