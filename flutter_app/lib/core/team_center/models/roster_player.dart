class RosterPlayer {
  ...
  factory RosterPlayer.fromJson(Map<String, dynamic> json) {
    return RosterPlayer(
      id: json['id'] as String? ?? '', // ID might not be in response, use empty string if so
  ...
  static List<RosterPlayer> getMockOffense(String teamId) {
    return [
      const RosterPlayer(
        ...
        experience: '19Y',
        college: 'California',
        imageUrl: 'https://images.unsplash.com/photo-1544383835-bda2bc66a55d?w=200&h=200&fit=crop',
      ),
      const RosterPlayer(
        id: '2',
        name: 'Garrett Wilson',
        ...
        experience: '2Y',
        college: 'Ohio State',
        imageUrl: 'https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?w=200&h=200&fit=crop',
      ),
      const RosterPlayer(
        id: '3',
        name: 'Breece Hall',
        ...
        experience: '2Y',
        college: 'Iowa State',
        imageUrl: 'https://images.unsplash.com/photo-1552058544-f2b08422138a?w=200&h=200&fit=crop',
      ),
      const RosterPlayer(
        id: '4',
        name: 'Tyron Smith',
  ...
  static List<RosterPlayer> getMockDefense(String teamId) {
    return [
      ...
      const RosterPlayer(
        ...
        experience: '5Y',
        college: 'Alabama',
        imageUrl: 'https://images.unsplash.com/photo-1531384441138-2736e62e0566?w=200&h=200&fit=crop',
      ),
      const RosterPlayer(
        id: '103',
        name: 'C.J. Mosley',
      ...
      const RosterPlayer(
        ...
        experience: '6Y',
        college: 'Kan. State',
        imageUrl: 'https://images.unsplash.com/photo-1499996860823-5214fcc65f6f?w=200&h=200&fit=crop',
      ),
      const RosterPlayer(
        id: '105',
  ...
  static List<RosterPlayer> getMockSpecialTeams(String teamId) {
    return [
      ...
      const RosterPlayer(
        ...
        experience: '15Y',
        college: 'SMU',
        imageUrl: 'https://images.unsplash.com/photo-1583195764036-6dc248ac07d9?w=200&h=200&fit=crop',
      ),
    ];
  }
}
