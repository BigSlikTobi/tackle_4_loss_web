        ...
        children: [
          Positioned.fill(
            child: BackdropFilter(
              ...
              child: Container(
                color: Colors.black.withValues(alpha: 0.5), // More transparent dark overlay
              ),
            ),
          ),
          ...
          SafeArea(
            child: FutureBuilder<TeamArticle>(
              ...
              initialData: widget.initialArticle, // Show what we have while loading
              builder: (context, snapshot) {
                ...
                if (article == null) {
                   return const Center(child: Text("Article not found", style: TextStyle(color: Colors.white)));
                }
                ...
                return SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // 3. Sub-headline
                      if (article.subHeadline != null && article.subHeadline!.isNotEmpty) ...[
                        Text(
                          article.subHeadline!,
                          style: const TextStyle(
                            fontFamily: 'Outfit',
                      ...
                      if (article.bulletPoints != null && article.bulletPoints!.isNotEmpty) ...[
                      ...
                      if (article.introduction != null && article.introduction!.isNotEmpty) ...[
                        Text(
