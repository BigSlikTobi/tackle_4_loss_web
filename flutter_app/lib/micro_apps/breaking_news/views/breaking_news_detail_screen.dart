        ...
        child: CustomScrollView(
          slivers: [
            ...
            SliverAppBar(
              expandedHeight: 300,
              pinned: true,
              backgroundColor: colors.surface.withValues(alpha: 0.9), // Match surface but slightly translucent
              leading: IconButton(
                icon: Container(
                        ...
                        Row(
                          children: [
                             if (displayArticle.sourceName != 'Source') ...[
                              ...
                              InkWell(
                                onTap: displayArticle.sourceUrl != null 
                                    ? () async {
                                        final uri = Uri.parse(displayArticle.sourceUrl!);
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        letterSpacing: 1.0,
                                        decoration: displayArticle.sourceUrl != null 
                             ...
                             Text(
                               DateFormat('MMM d, y • h:mm a').format(displayArticle.createdAt),
                               style: TextStyle(
                      ...
                      if (fullArticle != null) ...[
                        ...
                        if (fullArticle.content != null)
                          Text(
                            fullArticle.content!,
                            style: AppTextStyles.body.copyWith(
                              color: colors.textSecondary, // Softer for reading long text
                              fontSize: 16,
                              height: 1.6,
                            ),
                          ),
